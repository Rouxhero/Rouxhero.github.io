        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class=" mt-10 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex flex-row flex-wrap w-1/3 justify-between"><label> Nom :</label class="pt-2"><input type="text" id='name' name="name" class="h-7" value="" placeholder="Ex : Machine SUP RDC">      </div>              
                    <div class="flex flex-row flex-wrap w-1/3 justify-between"><label> Code :</label class="pt-2"><input type="text" id='code' name="code" class="h-7" value="" placeholder="Code sur la machine">        </div>                 
                </div>
            </div>
